...
c      call parasolopt(bbound,nopt,maxn,kstop,pcento,iseed,
c     *iiname, ngs,npg,nps,nspl,
c     *iniflg, iinr, inrhru,iobj, igoc,icalpar, 
c     *isens, sensw, isenspar,bestf,icalml, imet,omin,nobs,npt,i
c    * ,istat, iprob,varval)
      write(18011, *)
