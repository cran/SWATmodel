      module parm 
      real :: fixco, nfixmx, rsd_covco, buff_cf, vcrit
      ...
      real :: rch_san, rch_sil, rch_cla, rch_sag, rch_lag, sand
...
! msub = max number of subbasins
      ...
      real, dimension (:), allocatable :: sub_smfmx,sub_smfmn,sub_sftmp
      real, dimension (:), allocatable :: sub_smtmp, sub_timp
...
! mhru = maximum number of hydrologic response units
      ...
      real, dimension (:), allocatable :: grwat_w, grwat_d, grwat_veg
      real, dimension (:), allocatable :: grwat_s, grwat_a, grwat_spcon
      ...
      character(len=1), dimension (15000) :: hydgrp, kirr
!     character(len=4), dimension (50) :: urbname
      character(len=4), dimension (1000) :: urbname
      character(len=16), dimension (15000) :: snam
      character(len=17), dimension (300) :: pname
      character(len=13) :: heds(70),hedb(21),hedr(42),hedrsv(41)
...
! Input Uncertainty, added by Ann van Griensven
      integer ::  iseed, nauto, idlast, nsave
